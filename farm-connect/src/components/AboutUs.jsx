...
const AboutUs = () => {
  ...
  const content = {
    ...
    hi: {
      ...
      aboutTitle: "फार्म कनेक्ट के बारे में",
      aboutText1:
        "फार्म कनेक्ट एक डिजिटल B2B बाजार समाधान है जो किसानों और औद्योगिक खरीदारों को एक साथ लाता है। हम अपने सेवा साझेदारी नेटवर्क के संयोजन में अपने डिजिटल प्लेटफॉर्म के माध्यम से कृषि लेनदेन को बढ़ावा देते हैं। फार्म कनेक्ट खरीदार और विक्रेता के बीच ऑनलाइन भुगतान, उत्पाद गुणवत्ता जांच विकल्प और एंड-टू-एंड लॉजिस्टिक सेवाएं प्रदान करता है। फार्म कनेक्ट सिर्फ एक ब्रोकर नहीं है; हम किसानों को अपने प्लेटफॉर्म के माध्यम से अपने उत्पादों का आसानी से विपणन करने का अधिकार देते हैं।",
      aboutText2:
        "हमारे कृषि व्यवसाय अनुभव से, हम समझते हैं कि छोटे किसानों को उनके आकार और संसाधनों के अनुपात में चुनौतियों का सामना करना पड़ता है। प्रौद्योगिकी प्रदाता मुख्य रूप से बड़े उद्यमों की जरूरतों पर ध्यान केंद्रित करते हैं। फार्म कनेक्ट में, हम विक्रेताओं और खरीदारों के लिए एक दो-तरफा चैनल बनाकर समान अवसर प्रदान करने का लक्ष्य रखते हैं।",
      visionTitle: "दृष्टि",
      visionText:
