      ...
      if (user) {
        ...
        try {
          ...
          if (userDoc.exists()) {
            ...
            setUserRole("customer"); // Default role if not found
          }
        } catch (error) {
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="space-x-4 flex justify-center flex-wrap">
            ...
            {/* Conditional Add Product button - only shown to farmers */}
            {userRole === "farmer" && (
              <Link 
                to="/addproduct" 
      ...
      <section id="/services" className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            />
            <div className="p-6">
              <h3 className="text-2xl font-bold text-green-800 mb-4" data-translate="Fresh Fruits">
                {translate("Fresh Fruits")}
              </h3>
              <ul className="space-y-2 text-green-700">
                <li data-translate="🍎 Fresh Apples - ₹120/kg">{translate("🍎 Fresh Apples - ₹120/kg")}</li>
                <li data-translate="🍌 Ripe Bananas - ₹50/kg">{translate("🍌 Ripe Bananas - ₹50/kg")}</li>
                <li data-translate="🍊 Juicy Oranges - ₹100/kg">{translate("🍊 Juicy Oranges - ₹100/kg")}</li>
              </ul>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            />
            <div className="p-6">
              <h3 className="text-2xl font-bold text-green-800 mb-4" data-translate="Fresh Vegetables">
                {translate("Fresh Vegetables")}
              </h3>
              <ul className="space-y-2 text-green-700">
                <li data-translate="🥕 Crisp Carrots - ₹40/kg">{translate("🥕 Crisp Carrots - ₹40/kg")}</li>
                <li data-translate="🥬 Fresh Spinach - ₹20/bundle">{translate("🥬 Fresh Spinach - ₹20/bundle")}</li>
                <li data-translate="🍅 Ripe Tomatoes - ₹50/kg">{translate("🍅 Ripe Tomatoes - ₹50/kg")}</li>
              </ul>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            />
            <div className="p-6">
              <h3 className="text-2xl font-bold text-green-800 mb-4" data-translate="Farm Fresh Dairy">
                {translate("Farm Fresh Dairy")}
              </h3>
              <ul className="space-y-2 text-green-700">
                <li data-translate="🥛 Raw Milk - ₹40/liter">{translate("🥛 Raw Milk - ₹40/liter")}</li>
                <li data-translate="🧀 Artisan Cheese - ₹30/pack">{translate("🧀 Artisan Cheese - ₹30/pack")}</li>
                <li data-translate="🥣 Fresh Yogurt - ₹40/jar">{translate("🥣 Fresh Yogurt - ₹40/jar")}</li>
              </ul>
      ...
      <footer className="bg-green-900 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center space-x-6 mb-6">
            <a href="#home" className="hover:text-green-300" data-translate="Home">{translate("Home")}</a>
            <a href="#/services" className="hover:text-green-300" data-translate="Services">{translate("Services")}</a>
            <a href="#about" className="hover:text-green-300" data-translate="About Us">{translate("About Us")}</a>
            <a href="#contact" className="hover:text-green-300" data-translate="Contact">{translate("Contact")}</a>
          </div>
          <p className="mb-4" data-translate="© 2024 Agri Basket. All Rights Reserved.">{translate("© 2024 Agri Basket. All Rights Reserved.")}</p>
